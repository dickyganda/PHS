...
<main id="js-page-content" role="main" class="page-content">
    ...
    {{-- <input type="text" name="IdHolding" class="form-control" placeholder="ID Holding"> <br> --}}
    ...
    {{-- <input type="text" name="IdProduct" class="form-control" placeholder="ID Product"> <br> --}}
    ...
    <td id="col0">
<div class="form-group">
<select id="IdMaterial" name="IdMaterial[]" style="width: 100%" class="form-control form-control-sm select2" onchange="selectTypeProduct(this)">
