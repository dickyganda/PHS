...
<select id="InvoiceTo" name="InvoiceTo" style="width: 100%" class="form-control form-control-sm select2">
...
<label>Ship Date</label>
    ...
    <div class="form-group">
        <label>Due Date</label>
              <input type="date" class="form-control" id="DueDate" placeholder="DueDate" name="DueDate">
            </div>
