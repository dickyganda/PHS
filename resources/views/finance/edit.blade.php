...
<main id="js-page-content" role="main" class="page-content">
            ...
            <div id="panel-3" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <form action={{ route('financeupdate', $invoice->IdInvoiceDetail) }} method="POST" id="editinvoice">
                        @csrf
                        @method('put')
    ...
    <div class="form-group">
      ...
      {{-- <input type="text" class="form-control" id="TOIdDepartement" placeholder="TOIdDepartement" name="TOIdDepartement" value="{{ $invoice->TOIdDepartement }}"> --}}
    ...
    <div class="form-group">
      ...
      {{-- <input type="text" class="form-control" id="FROMIdDepartement" placeholder="FROMIdDepartement" name="FROMIdDepartement" value="{{ $invoice->FROMIdDepartement }}"> --}}
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="CheckedBy" placeholder="CheckedBy" name="CheckedBy" value="{{ $invoice->CheckedBy }}">
    </div>
    </div>
    <div class="col-lg-6">
    <div class="form-group">
      <label>ApprovedBy</label>
      <input type="text" class="form-control" id="ApprovedBy" placeholder="ApprovedBy" name="ApprovedBy" value="{{ $invoice->ApprovedBy }}">
    </div>
    </div>
    </div> --}}
    <div class="row">
