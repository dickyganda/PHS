                    ...
                    <div class="panel-content">
                        <div>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <a href="/purchasing/create" class="btn btn-success btn-xs"
                            ...
                            <table id="dt-basic-example"
                                ...
                                <tbody height="10px">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $carbon::parse($purchasing->DatePurchasing)->format('d/m/Y H:i:s') }}
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="/purchasing/printpurchasingorder/{{$purchasing->IdPurchasing}}"
                                                title="Print" class="btn btn-primary btn-xs" role="button"><i
                                                    class="fas fa-print"></i> Print</a>
                                            @endif

                                            @if($action->Edit == 1 && $action->IdMenu == 9)
                                            <a href="/purchasing/edit/{{ $purchasing->IdPurchasingDetail }}"
                                                title="Edit" class="btn btn-warning btn-xs" role="button"><i
                                                    class="fas fa-pen"></i> Edit</a>
                                            @endif

                                            @if($action->Delete == 1 && $action->IdMenu == 9)
                                            <form action="/purchasing/delete/{{ $purchasing->IdPurchasingDetail}}"
                                                method="post">
                                                @csrf
                                                @method('put')
                                            ...
                                            @if($purchasing->StatusCheckedPurchasing == 0)
                                            <form action="/purchasing/checked/{{ $purchasing->IdPurchasing}}"
                                                method="post">
                                                @csrf
                                                @method('put')
                                            ...
                                            @if($purchasing->StatusCheckedPurchasing == 1 && $purchasing->StatusApprovedPurchasing == 0 )
                                            <form action="/purchasing/checked/{{ $purchasing->IdPurchasing}}"
                                                method="post">
                                            ...
                                            @if($purchasing->StatusCheckedPurchasing == 1 && $purchasing->StatusApprovedPurchasing == 1)
                                            <form action="/purchasing/checked/{{ $purchasing->IdPurchasing}}"
                                                method="post">
                                                <button type="submit" class="btn btn-warning btn-xs"
                                                    hidden>Checked</button>
                                            ...
                                            {{-- jika punya akses approve --}}
                                            @if($action->Approve == 1 && $action->IdMenu == 9)
                                            @if($purchasing->StatusApprovedPurchasing == 0)
                                            <form action="/purchasing/approved/{{ $purchasing->IdPurchasing}}"
                                                method="post">
