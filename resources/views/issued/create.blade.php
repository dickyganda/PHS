...
<select id="DeliveredTo" name="DeliveredTo" style="width: 100%" class="form-control form-control-sm select2">
...
function addRows() {
                    ...
                    var table = document.getElementById('form_issued');
    ...
    $("#insertissued").submit(function(event){
